package com.gaming.tictactoe.utility;

public class GamingUtilityHelper {
	...
	//utility method for placing the symbol on the board
	...
	//to check if the position on the board is free
